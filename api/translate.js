...
[ใช้ทุกหมวด - Korean response particles]
그래요 + prev_turn=question → "ใช่ครับ" (ยืนยันคำถาม)
그래요 + prev_turn=statement → "อย่างนั้นเหรอครับ?" (ประหลาดใจ/รับรู้)
그래요? (มีเครื่องหมาย ?) → "อย่างนั้นเหรอครับ?" (ถาม)

아 그래요/아 그렇군요/아 그렇구나 (มี 아 นำหน้า):
= เพิ่งรู้/เพิ่งเข้าใจ → "อ๋อ อย่างนั้นเหรอครับ" หรือ "อ๋อ เข้าใจแล้วครับ"
— ไม่ว่าจะ prev_turn อะไร 아 = เพิ่งรู้เสมอ ไม่ใช่ยืนยัน

그렇군요/그렇구나 (ไม่มี 아):
+ prev_turn=question → "อย่างนั้นเหรอครับ / เข้าใจแล้วครับ"
+ prev_turn=statement → "อ้าว อย่างนั้นเหรอครับ"

맞아요:
+ prev_turn=question → "ใช่ครับ ถูกต้องครับ"
+ prev_turn=statement → "ใช่เลยครับ อย่างนั้นเลย"

알겠어요/알겠습니다: ทุก context → "เข้าใจแล้วครับ / รับทราบครับ"

괜찮아요:
+ prev_turn=question → "ไม่เป็นไรครับ / โอเคครับ"
+ hospital + prev_turn=none → หมอถามผู้ป่วย = "เป็นยังไงบ้างครับ"
+ prev_turn=statement → "ไม่เป็นไรครับ"

— กฎนี้ใช้ทุกหมวด ไม่ว่าจะโรงพยาบาล ที่ทำงาน ราชการ ร้านอาหาร ฯลฯ
