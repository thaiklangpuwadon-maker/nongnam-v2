...
พูดอีกที=다시 말해 주세요 | ได้=돼요 | ไม่ได้=안 돼요 | ไม่เป็นไร=괜찮아요`;
  ...
  const SITUATION_CONTEXT = {
    hospital: `บริบท: ผู้ใช้แอปคือคนไทยที่มาเป็นผู้ป่วย คู่สนทนาคือหมอหรือพยาบาลชาวเกาหลี
- หมอ/พยาบาลมักเป็นคนถาม เช่น เจ็บตรงไหน เป็นมานานแค่ไหน มีอาการอะไร
- คนไทยมักเป็นคนตอบหรืออธิบายอาการ
- ถ้าคนเกาหลีพูดสั้นๆ เช่น 어디가 아파요 = ถามว่าเจ็บตรงไหน ไม่ใช่บอกว่าเจ็บ
- ถ้าคนเกาหลีพูดว่า 괜찮아요 ในบริบทนี้ = ถามว่าเป็นยังไงบ้าง ไม่ใช่บอกว่าไม่เป็นไร`,

    work: `บริบท: ผู้ใช้แอปคือแรงงานไทยในโรงงาน คู่สนทนาคือนายจ้างหรือหัวหน้าชาวเกาหลี
- นายจ้าง/หัวหน้ามักเป็นคนสั่งงาน ถามงาน หรืออธิบายงาน
- แรงงานไทยมักเป็นคนตอบ รายงาน หรือขออนุญาต
- คำสั่งสั้นๆ จากเกาหลีมักเป็นคำสั่งงาน ไม่ใช่คำถาม
- ถ้าคนไทยพูดขึ้นต้น เช่น ขอลาออก ขอวันหยุด มักเป็นการขออนุญาต`,

    visa: `บริบท: ผู้ใช้แอปคือคนไทยที่มาติดต่อราชการ คู่สนทนาคือเจ้าหน้าที่ชาวเกาหลี
- เจ้าหน้าที่มักเป็นคนถามข้อมูล ขอเอกสาร หรืออธิบายขั้นตอน
- คนไทยมักเป็นคนตอบหรือขอความช่วยเหลือ
- ประโยคสั้นจากเกาหลีมักเป็นคำถามเชิงราชการ เช่น ชื่ออะไร มาทำอะไร`,

    bank: `บริบท: ผู้ใช้แอปคือคนไทยที่มาทำธุรกรรม คู่สนทนาคือพนักงานธนาคารชาวเกาหลี
- พนักงานมักเป็นคนถามว่าต้องการทำอะไร ขอข้อมูลบัญชี
- คนไทยมักเป็นคนบอกความต้องการหรือตอบคำถาม
- ถ้าพนักงานพูดว่า 어떻게 도와드릴까요 = จะให้ช่วยอะไรดีครับ/ค่ะ`,

    food: `บริบท: ผู้ใช้แอปคือคนไทยที่มาสั่งอาหาร คู่สนทนาคือพนักงานร้านชาวเกาหลี
- พนักงานมักถามว่าจะทานอะไร กี่ที่ ทานที่ร้านหรือห่อกลับ
- คนไทยมักเป็นคนสั่ง บอกความต้องการ
- ถ้าพนักงานพูดสั้นๆ เช่น 몇 분이세요 = มากี่คนครับ`,

    shop: `บริบท: ผู้ใช้แอปคือคนไทยที่มาช้อปปิ้ง คู่สนทนาคือพนักงานขายชาวเกาหลี
- พนักงานมักถามว่าต้องการอะไร ไซส์ไหน จะจ่ายยังไง
- คนไทยมักเป็นคนถามราคา หาของ หรือต่อราคา
- ทั้งสองฝ่ายอาจถามและตอบได้ทั้งคู่`,

    travel: `บริบท: ผู้ใช้แอปคือคนไทยที่กำลังเดินทาง คู่สนทนาอาจเป็นคนเกาหลีทั่วไปหรือเจ้าหน้าที่
- คนไทยมักเป็นคนถามทาง ถามสถานี ขอความช่วยเหลือ
- คนเกาหลีมักเป็นคนให้ทิศทางหรืออธิบาย
- ประโยคจากเกาหลีมักเป็นการบอกทาง ไม่ใช่คำถาม`,

    housing: `บริบท: ผู้ใช้แอปคือคนไทยที่คุยเรื่องที่พัก คู่สนทนาคือเจ้าของบ้านหรือนายหน้าชาวเกาหลี
- เจ้าของบ้านมักถามเรื่องระยะเวลาเช่า จำนวนคน เงื่อนไข
- คนไทยมักถามเรื่องราคา สภาพห้อง สิ่งอำนวยความสะดวก`,

    emergency: `บริบท: ผู้ใช้แอปคือคนไทยที่ต้องการความช่วยเหลือฉุกเฉิน
- คนไทยมักเป็นคนขอความช่วยเหลือหรืออธิบายสถานการณ์
- เจ้าหน้าที่หรือคนเกาหลีมักถามว่าเกิดอะไรขึ้น ต้องการอะไร
- ทุกประโยคจากเกาหลีในบริบทนี้มักเป็นคำถามเพื่อช่วยเหลือ`,

    money: `บริบท: ผู้ใช้แอปคือแรงงานไทยที่คุยเรื่องเงิน ประกัน หรือภาษีกับเจ้าหน้าที่เกาหลี
- เจ้าหน้าที่มักอธิบายระบบหรือขอข้อมูล
- คนไทยมักถามหรือขอความช่วยเหลือเรื่องเงิน`,
...
Output: cleaned text in source language only. No explanation.`;
  ...
  const TRANSLATE_SYSTEM = `You are a Thai-Korean interpreter for real spoken conversation.${contextHint}${historyHint}${situationCtx ? '\n' + situationCtx : ''}
