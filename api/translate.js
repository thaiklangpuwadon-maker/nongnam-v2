...
아 그래요/아 그렇군요/아 그렇구나: มี 아 นำหน้า = เพิ่งรู้/เพิ่งเข้าใจ → "อ๋อ อย่างนั้นเหรอครับ" หรือ "อ๋อ เข้าใจแล้วครับ"
그래요 (ไม่มี 아): ยืนยัน → question context = "ใช่ครับ" | statement context = "อย่างนั้นครับ"
그렇군요 (ไม่มี 아): เข้าใจ → "เข้าใจแล้วครับ / อย่างนั้นเหรอครับ"
— NEVER แปล 아 그래요 ว่า "ใช่ค่ะ" เพราะ 아 = เพิ่งรู้ ไม่ใช่ยืนยัน
