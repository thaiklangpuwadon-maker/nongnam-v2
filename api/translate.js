...
ซื่อ=이름(ชื่อ — คำอีสาน) | ข่อยซื่อ=제 이름은(ฉันชื่อ — อีสาน)
...
ตั๋ว/ขี้ตั๋ว=거짓말하다(โกหก) | จ่ม=투덜대다(บ่น) | ฮ้อง=부르다(เรียก/ร้อง)
...
[อาหารอีสาน+ไทย — เมื่อได้ยินคำเกี่ยวกับอาหาร]
ก้อย=고이(อาหารอีสานคล้ายลาบดิบ) | ก้อยเนื้อ=육회 스타일 | ก้อยปลา=생선 고이
ตำบักหุ่ง=파파야 샐러드(ส้มตำ) | ปลาแดก=젓갈(ปลาร้า) | แจ่วบอง=양념 젓갈
ลาบ=라브(ลาบ) | หมก=찜(ห่อหมก) | ข้าวเหนียว=찰밥
ซอยจุ๊=육회(เนื้อดิบ) | แกงอ่อม=아옴 카레 | อ่อม=아옴
ต้มแซ่บ=매운 갈비탕 | ป่น=볶음 소스

[อาหารไทยทั่วไป — เมื่อได้ยินคำเกี่ยวกับอาหาร]
ผัดกระเพรา=바질 볶음 | ต้มยำ=똠얌 | แกงเขียวหวาน=그린 카레
ข้าวมันไก่=카오만까이 | ผัดไทย=팟타이 | ข้าวผัด=볶음밥
ส้มตำ=파파야 샐러드 | ไก่ทอด=치킨 튀김

[คำอุทานเกาหลี→ไทย — แปลให้เป็นธรรมชาติ]
대박=โอ้โห/เจ๋งมาก | 아이고=โอ้โห/โอย | 어머=โอ้แม่เจ้า
진짜=จริงเหรอ/จริงๆ | 설마=ไม่ใช่หรอก | 왜=ทำไม
헐=อ้าว/งง | 대세=กระแสฮิต | 화이팅=สู้ๆ

[คำพูดล้อเล่น/ติดปากไทย-อีสาน]
ไปไหนมา=어디 갔다 왔어요? | กินข้าวหรือยัง=밥 먹었어요?
เป็นไงบ้าง=어때요? | โอเคบ่=괜찮아요?
ม่วนบ่=재밌어요? | แซ่บบ่=맛있어요?
